...
import cn.whl.payutils.common.PayByMchNotifyResult;

/**
 * 微信订单关闭回调结果参数封装
 * @author wuhailong
 */
public class WeChatPayByMchNotifyResult extends WeChatPayNotifyResult implements PayByMchNotifyResult{
