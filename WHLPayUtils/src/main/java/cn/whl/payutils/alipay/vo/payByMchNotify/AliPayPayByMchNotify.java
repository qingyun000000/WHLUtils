package cn.whl.payutils.alipay.vo.payByMchNotify;

import cn.whl.payutils.alipay.vo.AliPayNotify;
 ...
 * @author wuhailong
 */
public class AliPayPayByMchNotify extends AliPayNotify implements PayByMchNotifyIn{
